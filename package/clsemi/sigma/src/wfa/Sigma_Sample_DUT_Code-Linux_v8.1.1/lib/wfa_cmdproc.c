...
int xcCmdProcAgentSendPing(char *pcmdStr, BYTE *aBuf, int *aLen)
{
    ...
    for(;;)
    {
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);  
            strncpy(staping->dipaddr, str, sizeof(staping->dipaddr) - 1);
...
int xcCmdProcStaSetIpConfig(char *pcmdStr, BYTE *aBuf, int *aLen)
{
    ...
    for(;;)
    {
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);  
            strncpy(setip->intf, str, sizeof(setip->intf) - 1);
...
int xcCmdProcStaSetMacAddress(char *pcmdStr, BYTE *aBuf, int *aLen)
{
    ...
    for(;;)
    {
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);  
            strncpy(setmac.intf, str, sizeof(setmac.intf) - 1);
            DPRINT_INFO(WFA_OUT, "interface %s\n", setmac.intf);
        }
        else if(strcasecmp(str, "mac") == 0)
        {
            str = strtok_r(NULL, ",", &pcmdStr);  
            strncpy(setmac.cmdsu.macaddr, str, sizeof(setmac.cmdsu.macaddr) - 1);
...
int xcCmdProcStaVerifyIpConnection(char *pcmdStr, BYTE *aBuf, int *aLen)
{
    ...
    for(;;)
    {
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy(verifyip->cmdsu.verifyIp.dipaddr, str, sizeof(verifyip->cmdsu.verifyIp.dipaddr) - 1);
...
int  xcCmdProcStaSetEncryption(char *pcmdStr, BYTE *aBuf, int *aLen)
{
    ...
    for(;;)
    {
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);  
            strncpy(setencryp->intf, str, sizeof(setencryp->intf) - 1);
        }
        else if(strcasecmp(str, "ssid") == 0)
        {
            str = strtok_r(NULL, ",", &pcmdStr);  
            strncpy(setencryp->ssid, str, sizeof(setencryp->ssid) - 1);
        }
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);  
            strncpy((char *)setencryp->keys[0], str, sizeof(setencryp->keys[0]) - 1);
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);  
            strncpy((char *)setencryp->keys[1], str, sizeof(setencryp->keys[0]) - 1);
            DPRINT_INFO(WFA_OUT, "%s\n", setencryp->keys[1]);
        }
        else if(strcasecmp(str, "key3") == 0)
        {
            str = strtok_r(NULL, ",", &pcmdStr);  
            strncpy((char *)setencryp->keys[2], str, sizeof(setencryp->keys[0]) - 1);
            DPRINT_INFO(WFA_OUT, "%s\n", setencryp->keys[2]);
        }
        else if(strcasecmp(str, "key4") == 0)
        {
            str = strtok_r(NULL, ",", &pcmdStr);  
            strncpy((char *)setencryp->keys[3], str, sizeof(setencryp->keys[0]) - 1);
            DPRINT_INFO(WFA_OUT, "%s\n", setencryp->keys[3]);
        }
...
int xcCmdProcStaSetSecurity(char *pcmdStr, BYTE *aBuf, int *aLen)
{
    ...
    for(;;)
    {
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);  
            strncpy(cmd->intf, str, sizeof(cmd->intf) - 1);
        }
        else if(strcasecmp(str, "ssid") == 0)
        {
            str = strtok_r(NULL, ",", &pcmdStr);  
            strncpy(ssec->ssid, str, sizeof(ssec->ssid) - 1);
        ...
        else if(strcasecmp(str, "encpType") == 0)
        {
            ...
            if(strcasecmp(str, "tkip") == 0 || strcasecmp(str, "aes-ccmp") == 0)
               strncpy(ssec->encpType, str, sizeof(ssec->encpType) - 1);
        }
        ...
        else if(strcasecmp(str, "type") == 0)
        {
           ...
           if(strcasecmp(str, "psk") == 0)
           {
               ...
               {
                  str = strtok_r(NULL, ",", &pcmdStr);
                  strncpy(ssec->secu.passphrase, str, sizeof(ssec->secu.passphrase) - 1);
               }
           }
...
int xcCmdProcStaSetPSK(char *pcmdStr, BYTE *aBuf, int *aLen)
{
    ...
    for(;;)
    {
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);  
            strncpy((char *)setencryp->passphrase, str, sizeof(setencryp->passphrase) - 1);
        }
        else if(strcasecmp(str, "keyMgmtType") == 0)
        {
            str=strtok_r(NULL, ",", &pcmdStr);
            strncpy(setencryp->keyMgmtType, str, sizeof(setencryp->keyMgmtType) - 1);
        }
        else if(strcasecmp(str, "encpType") == 0)
        {
            str = strtok_r(NULL, ",", &pcmdStr);
	...
	else if (strcasecmp(str, "micAlg") == 0)
	{
		...
		strncpy(setencryp->micAlg, str, sizeof(setencryp->micAlg) - 1);
	    else
		strncpy(setencryp->micAlg, "SHA-1", sizeof(setencryp->micAlg) - 1);
	}
	else if (strcasecmp(str, "Prog") == 0)
	{
	    str = strtok_r(NULL, ",", &pcmdStr);
	    strncpy(setencryp->prog, str, sizeof(setencryp->prog) - 1);
	}
...
int xcCmdProcStaSetEapTLS(char *pcmdStr, BYTE *aBuf, int *aLen)
{
    ...
    for(;;)
    {
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);  
            strncpy(setsec->intf, str, sizeof(setsec->intf) - 1);
        }
        else if(strcasecmp(str, "ssid") == 0)
        {
            str = strtok_r(NULL, ",", &pcmdStr);  
            strncpy(setsec->ssid, str, sizeof(setsec->ssid) - 1);
        }
        else if(strcasecmp(str, "keyMgmtType") == 0)
        {
            str=strtok_r(NULL, ",", &pcmdStr);
            strncpy(setsec->keyMgmtType, str, sizeof(setsec->keyMgmtType) - 1);
        }
        else if(strcasecmp(str, "encpType") == 0)
        {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy(setsec->encrptype, str, sizeof(setsec->encrptype) - 1);
        }
...
int xcCmdProcStaSetEapTTLS(char *pcmdStr, BYTE *aBuf, int *aLen)
{
	...
	else if (strcasecmp(str, "micALg") == 0)
	{
	    str = strtok_r(NULL, ",", &pcmdStr);
	    if (strcasecmp(str, "SHA-1") != 0)
		strncpy(setsec->micAlg, str, sizeof(setsec->micAlg) - 1);
	    else
		strncpy(setsec->micAlg, "SHA-1", sizeof(setsec->micAlg) - 1);
	}
	else if (strcasecmp(str, "Prog") == 0)
	{
	    str = strtok_r(NULL, ",", &pcmdStr);
	    strncpy(setsec->prog, str, sizeof(setsec->prog) - 1);
	}
	else if (strcasecmp(str, "Perfer") == 0)
	{
	    str = strtok_r(NULL, ",", &pcmdStr);
...
int xcCmdProcStaSetEapSIM(char *pcmdStr, BYTE *aBuf, int *aLen)
{
    ...
    for(;;)
    {
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);  
            strncpy((char *)setsec->tripletSet[0], str, sizeof(setsec->tripletSet[0]) - 1);
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);  
            strncpy((char *)setsec->tripletSet[1], str, sizeof(setsec->tripletSet[0]) - 1);
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);  
            strncpy((char *)setsec->tripletSet[2], str, sizeof(setsec->tripletSet[0]) - 1);
            DPRINT_INFO(WFA_OUT, "Triplet1 : %s\n", setsec->tripletSet[2]);
...
int xcCmdProcStaSetPEAP(char *pcmdStr, BYTE *aBuf, int *aLen)
{
    ...
    for(;;)
    {
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy(setsec->trustedRootCA, str, sizeof(setsec->trustedRootCA) - 1);
        }
...
int xcCmdProcStaSetIBSS(char *pcmdStr, BYTE *aBuf, int *aLen)
{
    ...
    for(;;)
    {
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);  
            strncpy(setibss->intf, str, sizeof(setibss->intf) - 1);
            DPRINT_INFO(WFA_OUT, "interface %s\n", setibss->intf);
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);  
            strncpy(setibss->ssid, str, sizeof(setibss->ssid) - 1);
            DPRINT_INFO(WFA_OUT, "ssid %s\n", setibss->ssid);
        }
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy(setibss->keys[i++], str, sizeof(setibss->keys[0]) - 1);
...
int xcCmdProcStaGetInfo(char *pcmdStr, BYTE *aBuf, int *aLen)
{
    ...
    {
        str = strtok_r(NULL, ",", &pcmdStr);  
        strncpy(getInfo->intf, str, sizeof(getInfo->intf) - 1);
        DPRINT_INFO(WFA_OUT, "interface %s\n", getInfo->intf);
...
int xcCmdProcStaAssociate(char *pcmdStr, BYTE *aBuf, int *aLen)
{
    ...
    for(;;)
    {
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);  
            strncpy(setassoc->intf, str, sizeof(setassoc->intf) - 1);
            DPRINT_INFO(WFA_OUT, "interface %s\n", setassoc->intf);
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);  
            strncpy(setassoc->cmdsu.assoc.ssid, str, sizeof(setassoc->cmdsu.assoc.ssid) - 1);
            DPRINT_INFO(WFA_OUT, "ssid %s\n", setassoc->cmdsu.assoc.ssid);
        }
        else if(strcasecmp(str, "bssid") == 0)
        {
            str = strtok_r(NULL, ",", &pcmdStr);  
            strncpy(setassoc->cmdsu.assoc.bssid, str, sizeof(setassoc->cmdsu.assoc.bssid) - 1);
...
int xcCmdProcStaSetUAPSD(char *pcmdStr, BYTE *aBuf, int *aLen)
{
    ...
    for(;;)
    {
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);  
            strncpy(setuapsd->intf, str, sizeof(setuapsd->intf) - 1);
        }
        else if(strcasecmp(str, "ssid") == 0)
        {
            str = strtok_r(NULL, ",", &pcmdStr);  
            strncpy(setuapsd->ssid, str, sizeof(setuapsd->ssid) - 1);
        }
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy(setuapsd->peer, str, sizeof(setuapsd->peer) - 1);
        }
    }
...
int xcCmdProcStaSetMode(char *pcmdStr, BYTE *aBuf, int *aLen)
{
    ...
    for(;;)
    {
        ...
        {
           str = strtok_r(NULL, ",", &pcmdStr);
           strncpy(setmode->intf, str, sizeof(setmode->intf) - 1);
        }
        else if(strcasecmp(str, "ssid") == 0)
        {
           str = strtok_r(NULL, ",", &pcmdStr);
           strncpy(setmode->ssid, str, sizeof(setmode->ssid) - 1);
        }
        else if(strcasecmp(str, "encpType") == 0)
        {
           str = strtok_r(NULL, ",", &pcmdStr);
        ...
        {
           str = strtok_r(NULL, ",", &pcmdStr);
           strncpy((char *)setmode->keys[0], str, sizeof(setmode->keys[0]) - 1);
           DPRINT_INFO(WFA_OUT, "%s\n", setmode->keys[0]);
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy((char *)setmode->keys[1], str, sizeof(setmode->keys[0]) - 1);
            DPRINT_INFO(WFA_OUT, "%s\n", setmode->keys[1]);
        }
        else if(strcasecmp(str, "key3") == 0)
        {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy((char *)setmode->keys[2], str, sizeof(setmode->keys[0]) - 1);
            DPRINT_INFO(WFA_OUT, "%s\n", setmode->keys[2]);
        }
        else if(strcasecmp(str, "key4") == 0)
        {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy((char *)setmode->keys[3], str, sizeof(setmode->keys[0]) - 1);
            DPRINT_INFO(WFA_OUT, "%s\n", setmode->keys[3]);
        }
        else if(strcasecmp(str, "activeKey") == 0)
        {
...
int xcCmdProcStaSendP2pProvDisReq(char *pcmdStr, BYTE *aBuf, int *aLen)
{
   ...
   for(;;)
   {
      ...
      {
         str = strtok_r(NULL, ",", &pcmdStr);  
         strncpy(staSendP2pProvDisReq->confMethod, str, sizeof(staSendP2pProvDisReq->confMethod) - 1);
      }
      else if(strcasecmp(str, "p2pdevid") == 0)
      {
         str = strtok_r(NULL, ",", &pcmdStr);  
...
int xcCmdProcStaSetPwrSave(char *pcmdStr, BYTE *aBuf, int *aLen)
{
    ...
    for(;;)
    {
        ...
        {
           str = strtok_r(NULL, ",", &pcmdStr);
           strncpy(setps->intf, str, sizeof(setps->intf) - 1);
        }
        else if(strcasecmp(str, "mode") == 0)
        {
           str = strtok_r(NULL, ",", &pcmdStr);
           strncpy(setps->mode, str, sizeof(setps->mode) - 1);
        }
    }
...
int xcCmdProcStaSetWMM(char *pcmdStr, BYTE *aBuf, int *aLen)
{
    ...
    for(;;)
    {
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);  
            strncpy(setwmm->intf, str, sizeof(setwmm->intf) - 1);
        }
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy(setwmm->dipaddr, str, sizeof(setwmm->dipaddr) - 1);
        }
        ...
        else if (strcasecmp(str, "program") == 0)
        {
            ...
            if (strcasecmp(str, "PMF") == 0)
            {
                ...
                for(;;)
                {
                    ...
                    {
                        str = strtok_r(NULL, ",", &pcmdStr);  
                        strncpy(pmf->sender, str, sizeof(pmf->sender) - 1);
                        pmf->sender[7]='\0';
                        pmf->sender_flag =1;
                    }
                    else if (strcasecmp(str, "bssid") == 0)
                ...
                for(;;)
                {
                    ...
                    if (strcasecmp(str, "framename") == 0)
                    {
                        ...
                        if (strcasecmp(str, "transmgmt") == 0)
                        {
                            ...
                            str = strtok_r(NULL, ",", &pcmdStr);
                            strncpy(vent->ssid, str, WFA_SSID_NAME_LEN - 1);
                        }
                    }
                }
            }
...
int xcCmdProcStaSetWireless(char *pcmdStr, BYTE *aBuf, int *aLen)
{
    ...
    for(;;)
    {
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy(staWirelessParams->intf, str, sizeof(staWirelessParams->intf) - 1);
        }
        if(strcasecmp(str, "program") == 0) // VHT or 11n or Voice
        {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy(staWirelessParams->program, str, sizeof(staWirelessParams->program) - 1);
...
int xcCmdProcStaSet11n(char *pcmdStr, BYTE *aBuf, int *aLen)
{
    ...
    for(;;)
    {
        ...
        {
            str = strtok_r(NULL, ",", &pcmdStr);
            strncpy(v11nParams->mcs_fixedrate, str, sizeof(v11nParams->mcs_fixedrate) - 1);
        ...
        else if(strcasecmp(str, "program") == 0)
        {
            ...
            if (strcasecmp(str, "WFD") == 0)
            {
                ...
                for(;;)
                {
                    ...
                    {
                        str = strtok_r(NULL, ",", &pcmdStr);
                        strncpy(pWfdEvent->wfdI2cData, str, strlen(pWfdEvent->wfdI2cData) - 1);
