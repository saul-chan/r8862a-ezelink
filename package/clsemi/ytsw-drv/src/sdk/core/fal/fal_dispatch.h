...
typedef struct fal_dispatch_s 
{
    ...
    yt_ret_t (*vlan_protocol_based_vlan_group_set)(yt_unit_t, uint8_t, yt_vlan_protocol_key_t);
    yt_ret_t (*vlan_protocol_based_vlan_group_get)(yt_unit_t, uint8_t, yt_vlan_protocol_key_t *);
    yt_ret_t (*vlan_protocol_based_vlan_table_set)(yt_unit_t, yt_port_t, uint8_t, yt_vlan_protocol_action_t);
    yt_ret_t (*vlan_protocol_based_vlan_table_get)(yt_unit_t, yt_port_t, uint8_t, yt_vlan_protocol_action_t *);
    yt_ret_t (*vlan_protocol_based_vlan_table_del)(yt_unit_t, yt_port_t, uint8_t);
    ...
    yt_ret_t (*nic_rx_register)(yt_unit_t, yt_nic_rx_cb_f);
    yt_ret_t (*nic_rx_handler)(yt_unit_t);
    yt_ret_t (*nic_tx)(yt_unit_t, yt_tx_pkt_t *, uint8_t);
    yt_ret_t (*nic_eth_buf_cnt_len_set)(yt_unit_t, uint16_t, uint16_t, uint16_t);
    yt_ret_t (*nic_eth_debug_flag_set)(yt_unit_t, uint8_t);
    yt_ret_t (*nic_eth_drv_init)(yt_unit_t);
    ...
    yt_ret_t (*debug_phyLoopback_test_set)(yt_unit_t, yt_port_t,  yt_phy_loopback_mode_t);
} fal_dispatch_t;
