...
typedef struct yt_phy_drv_func_s
{
    ...
    yt_ret_t (*phy_crossover_mode_set)(yt_unit_t, uint8_t, yt_utp_crossover_mode_t);
    yt_ret_t (*phy_crossover_mode_get)(yt_unit_t, uint8_t, yt_utp_crossover_mode_t *);
    yt_ret_t (*phy_crossover_status_get)(yt_unit_t, uint8_t, yt_utp_crossover_status_t *);
    yt_ret_t (*phy_loopback_set)(yt_unit_t, uint8_t, yt_phy_loopback_mode_t);
}yt_phy_drv_func_t;
