...
struct switch_field_def switch_l3_routing_default[] = {
	...
	{L3_ROUTING_DEFAULT_ARG_MMPVALID, "mmpValid", 1, 12},
	{L3_ROUTING_DEFAULT_ARG_MMPPTR, "mmpPtr", 5, 13},
	{L3_ROUTING_DEFAULT_ARG_MMPORDER, "mmpOrder", 2, 18},
};
...
struct switch_field_def switch_next_hop_table[] = {
	...
	{NEXT_HOP_TABLE_ARG_TUNNELENTRYPTR, "tunnelEntryPtr", 4, 22},
	{NEXT_HOP_TABLE_ARG_TUNNELEXIT, "tunnelExit", 1, 26},
	{NEXT_HOP_TABLE_ARG_TUNNELEXITPTR, "tunnelExitPtr", 4, 27},
	{NEXT_HOP_TABLE_ARG_METADATA, "metaData", 16, 31},
};
