...
struct cmd_module switch_cmd[] = {
	...
	{"tunnel", switch_tunnel_config, switch_tunnel_usage},
	{"learning", switch_learning_config, switch_learning_usage},
	{"mac_range", switch_mac_range_config, switch_mac_range_usage},
