...
ISP1220_TRIM6_GETVOL () {
	...
	print_vol_value=$(awk 'BEGIN{printf "%.2f\n", (('$ISP1220_DC_1V5_BASE' - '$isp1220_trim6_val') * '$ISP1220_1V5_Unit' + '$ISP1220_1V5_Vol' - '$ISP1220_1V5_Float') * '1000'}')
		...
		"AVDD18_RF" )
			...
			;;
                "V0V8_DCDC" )
                        ...
                        ;;
                "DDR_VDDQ" )
                        deltaVoltage=$(awk 'BEGIN{printf "%.0f\n", '$ISP1220_DC_1V5_BASE' - (('$AdjustVoltage' - '$ISP1220_1V5_Vol' + '$ISP1220_1V5_Float')/'$ISP1220_1V5_Unit')}')
                        if [ $deltaVoltage -gt 255 ] || [ $deltaVoltage -lt 0 ]; then
                                echo "$VoltageBus Setting $AdjustVoltage V is not in Setting Range"
                                exit 1
                        fi
