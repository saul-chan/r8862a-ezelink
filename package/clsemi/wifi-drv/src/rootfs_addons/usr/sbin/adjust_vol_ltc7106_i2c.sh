...
LTC7106_1V8_I2C_Addr='0x4c'
LTC7106_1V2_I2C_Addr='0x2c'
...
LTC7106_V0V8_DCDC_INIT () {
	# NOMINAL Mode
	i2ctransfer -f -y $i2cdev_Port w2@$LTC7106_0V8_I2C_Addr 0x01 0x80
        usleep 10000

	# Set IDAC
	i2ctransfer -f -y $i2cdev_Port w2@$LTC7106_0V8_I2C_Addr 0xE4 0x40
        usleep 10000
...
LTC7106_V0V8_DCDC_SETVOL () {
	...
	i2ctransfer -f -y $i2cdev_Port w2@$LTC7106_0V8_I2C_Addr 0xE8 $vol_value
        usleep 10000
}

LTC7106_V0V8_DCDC_GETVOL () {
	ltc7106_v0v8_reg=$(i2ctransfer -f -y $i2cdev_Port w1@$LTC7106_0V8_I2C_Addr 0xE8 r1 | awk '{print $1}')
