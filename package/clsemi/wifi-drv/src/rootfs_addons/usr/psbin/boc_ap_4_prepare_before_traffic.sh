...
arp -s 192.168.52.2 D0:44:33:19:11:20;
arp -v;

#echo 793 > /sys/kernel/debug/ieee80211/phy0/cls_wifi/stations/d0:44:33:19:11:00/rc/fixed_rate_idx;
echo 1069 > /sys/kernel/debug/ieee80211/phy0/cls_wifi/stations/d0:44:33:19:11:20/rc/fixed_rate_idx;
