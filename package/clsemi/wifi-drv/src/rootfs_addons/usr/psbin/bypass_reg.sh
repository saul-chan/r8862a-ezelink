...
#msg_string="0F380E001000 0C00 01000000 0800814c AAAAAA02"
msg_string="0F380E0010000C00010000000800814cAAAAAA02"
echo -n "$msg_string" > $msg_path

#devmem 0x4c818008 32 0x02AAAAAA
msg_string="0F380E0010000C00010000000880814cAAAAAA02"
echo -n "$msg_string" > $msg_path

###DPD硬旁路
#devmem 0x4c820000 32 0
msg_string="0F380E0010000C00010000000000824c00000000"
echo -n "$msg_string" > $msg_path
#devmem 0x4c820004 32 0
msg_string="0F380E0010000C00010000000400824c00000000"
echo -n "$msg_string" > $msg_path
#devmem 0x4c820018 32 0x0
msg_string="0F380E0010000C00010000001800824c00000000"
echo -n "$msg_string" > $msg_path
devmem 0x4c82001C 32 0x0
msg_string="0F380E0010000C00010000001C00824c00000000"
echo -n "$msg_string" > $msg_path
#devmem 0x4c820030 32 0x0
msg_string="0F380E0010000C00010000003000824c00000000"
echo -n "$msg_string" > $msg_path
devmem 0x4c820034 32 0x0
msg_string="0F380E0010000C00010000003400824c00000000"
echo -n "$msg_string" > $msg_path
devmem 0x4c820038 32 0x0
msg_string="0F380E0010000C00010000003800824c00000000"
echo -n "$msg_string" > $msg_path
devmem 0x4c82007C 32 0
msg_string="0F380E0010000C00010000007C00824c00000000"
echo -n "$msg_string" > $msg_path
devmem 0x4c8201C4 32 2
msg_string="0F380E001000 0C00 01000000 0000824c 00000000"
echo -n "$msg_string" > $msg_path
#devmem 0x4c8201C8 32 2
msg_string="0F380E0010000C0001000000C801824c02000000"
echo -n "$msg_string" > $msg_path
#devmem 0x4c820284 32 2
msg_string="0F380E0010000C00010000008402824c02000000"
echo -n "$msg_string" > $msg_path
#devmem 0x4c8203C4 32 0x0
msg_string="0F380E0010000C0001000000c403824c00000000"
echo -n "$msg_string" > $msg_path
...
msg_string="0F380E0010000C00010000003420824c00000000"
echo -n "$msg_string" > $msg_path
