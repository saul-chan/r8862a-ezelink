...
#include <hal/phy/construct/conf_rtl8264b.c>
  ...
  #include <hal/phy/construct/conf_rtl8261n_c_lp.c>
#else
...
static int32 _phy_rtl826xb_flow_s(uint32 unit, rtk_port_t port, uint8 portOffset, uint8 patch_mode)
{
    ...
    {
        RT_ERR_CHK(phy_patch_op(pPatchDb, unit, port, portOffset, RTK_PATCH_OP_PSDS0, 0xff, 0x07, 0x11, 0, 0, 0x0, patch_mode), ret);
    }
