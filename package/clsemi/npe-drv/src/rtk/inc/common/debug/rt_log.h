...
#else 
  #define RT_LOG(level, module, args...)                  printk(args) 
  #define RT_ERR(error_code, module, fmt, args...)        printk(fmt, ##args) 
  #define RT_INIT_ERR(error_code, module, fmt, args...)   printk(fmt, ##args)
  #define RT_INIT_MSG(fmt, args...)                       printk(fmt, ##args)
#endif
