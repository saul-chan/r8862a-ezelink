/*
 * Copyright (C) 2009-2023 Realtek Semiconductor Corp.
 * All Rights Reserved.
 *
 ...
 * $Date: $
 *
 * Purpose : unified PHY patch flow
 *
 * Feature : unified PHY patch flow
 *
 */
 ...
 * Symbol Definition
 */
#define PHYPATCH_PHYCTRL_IN_HALCTRL   1  /* 3.6.x: 1 ,4.0.x: 1, 4.1.x+: 0 */
#define PHYPATCH_FAMILY_ID_IN_HWP     1  /* 3.6.x: 1 ,4.0.x: 0, 4.1.x+: 0 */
#define PHY_PATCH_MODE_BCAST_DEFAULT  PHY_PATCH_MODE_BCAST_BUS  /* 3.6.x: PHY_PATCH_MODE_BCAST_BUS ,4.0.x+: PHY_PATCH_MODE_BCAST */
 ...
 */
...
#if PHYPATCH_FAMILY_ID_IN_HWP
  #define PHYPATCH_IS_RTKSDS(_unit) (HWP_9300_FAMILY_ID(_unit) || HWP_9310_FAMILY_ID(_unit))
  #define PHYPATCH_SDS_NOT_SUPPORT_USXGMII_AN(_unit) (HWP_9300_FAMILY_ID(_unit) || HWP_9310_FAMILY_ID(_unit))
#else
  ...
  #define PHYPATCH_SDS_NOT_SUPPORT_USXGMII_AN(_unit) (RTK_9300_FAMILY_ID(_unit) || RTK_9310_FAMILY_ID(_unit))
#endif
