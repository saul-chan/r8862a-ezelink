...
typedef struct {
    ...
    SHORT rsrp;
    SHORT snr;
} __attribute__ ((packed)) QMINAS_SIG_INFO_5G_TLV_MSG, *PQMINAS_SIG_INFO_5G_TLV_MSG;
...
#define FIBO_MODIFY_PROFILE_SETTINGS_REQ  0x0045
#define FIBO_MODIFY_PROFILE_SETTINGS_RESP 0x0045

#define QMI_FIBO_WDS_X35_GET_PROFILE_INFO_REQ_V01 0x0042
#define QMI_FIBO_WDS_X35_GET_PROFILE_INFO_RESP_V01 0x0042
#define QMI_FIBO_WDS_X35_SET_PROFILE_INFO_REQ_V01 0x0043
#define QMI_FIBO_WDS_X35_SET_PROFILE_INFO_RESP_V01 0x0043


typedef struct _FIBO_PDPTYPE {
    UCHAR TLVType;
    USHORT TLVLength;
    // 0 ?C PDP-IP (IPv4)
    // 1 ?C PDP-PPP
    ...
    // 3 ?C PDP-IPv4v6
    UINT PdpType;
} __attribute__((packed)) FIBO_PDPTYPE, *PFIBO_PDPTYPE;


typedef struct _FIBO_SET_PROFILE_REQ_MSG {
    USHORT Type;
    USHORT Length;
    UCHAR TLVType;
    USHORT TLVLength;
    UCHAR ProfileIndex;
} __attribute__((packed)) FIBO_SET_PROFILE_REQ_MSG,
    *PFIBO_SET_PROFILE_REQ_MSG;


typedef struct _FIBO_SET_PROFILE_RESP_MSG {
    USHORT Type;
    USHORT Length;
    UCHAR TLVType;
    USHORT TLVLength;
    USHORT QMUXResult;
    USHORT QMUXError;
} __attribute__((packed)) FIBO_SET_PROFILE_RESP_MSG,
    *PFIBO_SET_PROFILE_RESP_MSG;
...
//2021-03-24 willa.liu@fibocom.com changed end for support mantis 0071817
    ...
    FIBO_SET_PROFILE_REQ_MSG setProfileReq;
    FIBO_SET_PROFILE_RESP_MSG setProfileResp;
