...
//add api to get signal for IRP-20220900249
...
extern int requestSetProfile_by_m2m(PROFILE_T *profile, int product);
...
extern int fibo_get_netcard_driver_info(const char *devname);
...
extern int qmiclientId[QMUX_TYPE_M2M + 1];
