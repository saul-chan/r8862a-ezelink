...
static const QMI_NAME_T qmux_nas_Type[] = {
    ...
    qmi_name_item(QMINAS_GET_SIG_INFO_REQ),       //                 0x004F
    qmi_name_item(QMINAS_GET_SIG_INFO_RESP),       //                0x004F
};
...
/*
static const QMI_NAME_T qmux_m2m_Type[] = {
    qmi_name_item(FIBO_MODIFY_PROFILE_SETTINGS_REQ),	    //       0x002F
    qmi_name_item(FIBO_MODIFY_PROFILE_SETTINGS_RESP),	    //       0x002F
};
*/
