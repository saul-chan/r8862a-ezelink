...
#define FRAMESZ_BOOTCODE    528   //0x210   // frame size for bootcode
#define FRAMESZ_PDL         2048  //0x800   // frame size for PDL
#define FRAMESZ_FDL         2112  //0x840   // frame size for fdl1
#define FRAMESZ_DATA        12288 //0x3000  // frame size for others
#define FRAMESZ_OUT_DATA    64512 //0xfc00  // windows use this value

#define IMEI2_ITEM_ID        0x179
#define BT_CONFIG_ITEM_ID    0x191
#define STATIC_NV_ITEM_ID    0x259
#define STATIC_NV_2_ITEM_ID  0x25C
#define RF_NV_ITEM_ID        0x26C
#define AUDIO_CALIB_ITEM_ID  0x278
#define VERSION_ITEM_ID      0x27B
...
typedef enum
{
    ...
    BSL_CMD_ENABLE_WRITE_FLASH = 0x1b,  /* add for sl8563*/
