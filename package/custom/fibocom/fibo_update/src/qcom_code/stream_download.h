#ifndef _STREAM_DOWNLOAD_H_
#define _STREAM_DOWNLOAD_H_
...
int stream_download_main(const char *image_dir, void *usb_handle, uint32_t qusb_zlp_mode);

#endif /* _STREAM_DOWNLOAD_H_ */
