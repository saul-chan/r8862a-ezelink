 ...
 *  @param [in] bWaitOpen : wait to open device or not
 *
 *  @return TRUE if open success, FALSE otherwise
 */
	virtual bool	Open( PCCHANNEL_ATTRIBUTE pOpenArgument, bool bWaitOpen = false )=0;
/**
 *  Close channel
 *
 *  @return void
 ...
 */
	...
	*/
    ...
    /**
     * Example Test the port connection status
     * @brief IsConnect
     * @return TRUE  Port unicom , FALSE   Port is closed or lost
     */
