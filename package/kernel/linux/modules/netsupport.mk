...
define KernelPackage/cls-yt-dsa
  SUBMENU:=$(NETWORK_SUPPORT_MENU)
  TITLE:=ClourneySemi yt dsa support
  KCONFIG:=CONFIG_NET_DSA=y \
	   CONFIG_NET_DSA_MOTORCOMM=m \
	   CONFIG_NET_DSA_TAG_MOTORCOMM=y \
	   CONFIG_NET_DSA_VLAN_MOTORCOMM=m \
	   CONFIG_NET_DSA_VLAN_TAG_MOTORCOMM=y
  FILES:=$(LINUX_DIR)/drivers/net/dsa/motorcomm/motorcomm_vlan_tag.ko
endef

define KernelPackage/cls-yt-dsa/description
 Kernel module for Clourney Semiconductor yt dsa support
endef

$(eval $(call KernelPackage,cls-yt-dsa))
