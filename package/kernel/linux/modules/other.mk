...
define KernelPackage/cls-tsens
  SUBMENU:=$(OTHER_MENU)
  TITLE:=ClourneySemi T-Sensor monitoring support
  KCONFIG:=CONFIG_CLS_TSENS
  FILES:=$(LINUX_DIR)/drivers/thermal/clourney/cls_tsens.ko
  AUTOLOAD:=$(call AutoProbe,cls-tsens)
endef

define KernelPackage/cls-tsens/description
 Kernel module for Clourney Semiconductor thermal monitor
endef

$(eval $(call KernelPackage,cls-tsens))
