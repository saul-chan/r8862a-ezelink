...
/*  The Distribution of ECC Segment and Spare Area in a Page  */
/*  User meta dataI is not Protected by ECC, User meta dataII is Protected by ECC  */
...
/*
 * Right now, spinand core drvier support ECC, so let the whole oob area is available for user.
 */
