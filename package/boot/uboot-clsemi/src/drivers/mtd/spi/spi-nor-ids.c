...
const struct flash_info spi_nor_ids[] = {
	...
	{ INFO("w25q512nw", 0xef8020, 0, 64 * 1024, 1024, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) },
	...
	{ INFO("ZD25Q256", 0xef8019, 0, 64 * 1024, 512, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) },
#endif
