...
fal_dispatch_t  fal_tiger_dispatch = 
{
    ...
    .vlan_protocol_based_vlan_group_set = fal_tiger_vlan_protocol_based_vlan_group_set,
    .vlan_protocol_based_vlan_group_get = fal_tiger_vlan_protocol_based_vlan_group_get,
    .vlan_protocol_based_vlan_table_set = fal_tiger_vlan_protocol_based_vlan_table_set,
    .vlan_protocol_based_vlan_table_get = fal_tiger_vlan_protocol_based_vlan_table_get,
    .vlan_protocol_based_vlan_table_del = fal_tiger_vlan_protocol_based_vlan_table_del,
#endif
    ...
    .nic_rx_register = fal_tiger_nic_rx_register,
    .nic_rx_handler = fal_tiger_nic_rx_handler,
    .nic_tx = fal_tiger_nic_tx,
    .nic_eth_buf_cnt_len_set = fal_tiger_nic_eth_buf_cnt_len_set,
    .nic_eth_debug_flag_set = fal_tiger_nic_eth_debug_flag_set,
    .nic_eth_drv_init = fal_tiger_nic_eth_drv_init,
#endif
