...
yt_ret_t profile_yt9215s_fib_init(yt_hwProfile_info_t *hwprofile_info)
{
    ...
    yt9215s_fib_swDescp.sw_access.swreg_acc_method = SWCHIP_ACC_SMI;
	yt9215s_fib_swDescp.sw_access.controller.smi_controller.switchId = 0x0;
	yt9215s_fib_swDescp.sw_access.controller.smi_controller.phyAddr = 0x1d;
	yt9215s_fib_swDescp.sw_access.controller.smi_controller.smi_write = yt_smi_cl22_write;
	yt9215s_fib_swDescp.sw_access.controller.smi_controller.smi_read = yt_smi_cl22_read;
