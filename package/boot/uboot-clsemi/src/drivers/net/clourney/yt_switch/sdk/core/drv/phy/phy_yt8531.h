...
yt_ret_t yt8531_crossover_mode_set(yt_unit_t, uint8_t, yt_utp_crossover_mode_t);
yt_ret_t yt8531_crossover_mode_get(yt_unit_t, uint8_t, yt_utp_crossover_mode_t *);
yt_ret_t yt8531_crossover_status_get(yt_unit_t, uint8_t, yt_utp_crossover_status_t *);
yt_ret_t yt8531_loopback_set(yt_unit_t, uint8_t, yt_phy_loopback_mode_t);