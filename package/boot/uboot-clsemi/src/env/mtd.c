...
#if CONFIG_ENV_SIZE_MTD_REDUND < CONFIG_ENV_SIZE
#undef CONFIG_ENV_SIZE_MTD_REDUND
#define CONFIG_ENV_SIZE_MTD_REDUND CONFIG_ENV_SIZE
#endif
...
static int env_mtd_save(void)
{
	...
	ret = mtd_io_skip_bad(mtd, false, CONFIG_ENV_OFFSET, CONFIG_ENV_SIZE,
			      CONFIG_ENV_SIZE_MTD_REDUND, (u8 *)env_new);
...
static int readenv(size_t offset, u_char *buf)
{
	...
	ret = mtd_io_skip_bad(mtd, true, offset, CONFIG_ENV_SIZE,
			      CONFIG_ENV_SIZE_MTD_REDUND, buf);
