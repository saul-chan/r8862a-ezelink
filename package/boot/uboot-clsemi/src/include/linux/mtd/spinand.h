...
#define STATUS_ECCSE1		BIT(5)
#define STATUS_ECCSE0		BIT(4)
...
extern const struct spinand_manufacturer fudan_micro_spinand_manufacturer;
extern const struct spinand_manufacturer longsys_foresee_spinand_manufacturer;
/**
