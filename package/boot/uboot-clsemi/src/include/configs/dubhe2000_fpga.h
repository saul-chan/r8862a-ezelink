...
#define CONFIG_BOOTCOMMAND              "and read 0x10000000 0x900000 0x2000000;bootm 0x10000000"
#endif

#if (CONFIG_BRD_BOOT_FLASH_VARIANT == BRD_BOOT_FROM_SPINAND)
#define CONFIG_BOOTCOMMAND              "mtd read spi-nand0 0x10000000 0x900000 0x2000000;bootm 0x10000000"
#endif
