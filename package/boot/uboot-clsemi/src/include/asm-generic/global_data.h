...
# endif
	...
	char *smbios_version;
#endif
#if CONFIG_IS_ENABLED(SYSINFO_SUPPORT)
	/**
	 * @sysinfo_addr: address of system information structure
	 *
	 * @sysinfo_addr contains the address of the structure holding the
	 * system information variables.
	 */
	unsigned long sysinfo_addr;
	/**
	 * @sysinfo_valid: system information is valid
	 *
	 * See &enum sysinfo_valid
	 */
	unsigned long sysinfo_valid;
	/**
	 * @sysinfo_has_init: bit mask indicating system information locations
	 *
	 * &enum env_location defines which bit relates to which location
	 */
	unsigned long sysinfo_has_init;
	/**
	 * @sysinfo_load_prio: priority of the loaded system information
	 */
	int sysinfo_load_prio;
	/**
	 * @sysinfo_buf: buffer for sysinfo_env_get() before reloc
	 */
	char sysinfo_buf[32];
#endif
};
...
#if CONFIG_IS_ENABLED(SYSINFO_SUPPORT)
	/**
	 * @GD_FLG_SYSINFO_READY: system information imported into hash table
	 */
	GD_FLG_SYSINFO_READY = 0x100000,
	/**
	 * @GD_FLG_SYSINFO_DEFAULT: default system information variable flag
	 */
	GD_FLG_SYSINFO_DEFAULT = 0x200000,
#endif
};
