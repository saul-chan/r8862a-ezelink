...
#ifndef _ASM_ARMV8_CLS_DUBHE2000_CONFIG_H_
#define _ASM_ARMV8_CLS_DUBHE2000_CONFIG_H_
...
#define COREn_RST_REG                  (CPU_LSYS_ADDR + 0x42800)
...
#endif /* _ASM_ARMV8_CLS_DUBHE2000_CONFIG_H_ */
