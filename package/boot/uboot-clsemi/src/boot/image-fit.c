...
#define CLS_HIDE_IMINFO
#if defined(CLS_HIDE_IMINFO) && !defined(USE_HOSTCC)
#define printf(fmt, args...) do{ if(1 == env_get_yesno("cls_iminfo_print"))\
							{printf(fmt, ##args);}  \
							}while(0)
#endif
/*****************************************************************************/
...
void fit_image_print(const void *fit, int image_noffset, const char *p)
{
	...
	if (ret)
		...
		if(1 == env_get_yesno("cls_iminfo_print"))
