...
extern bool wireless_brvlan_conf_update;
extern struct vlist_tree wireless_brvlans;
...
struct wireless_brvlan_vlan {
	uint16_t vid;
	uint16_t flags;
};

struct wireless_brvlan {
	struct vlist_node node;

	char *section;
	int n_vlans;
	struct wireless_brvlan_vlan *vlans;
};
