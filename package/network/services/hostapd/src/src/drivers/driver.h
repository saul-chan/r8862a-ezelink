...
struct wpa_driver_ops {
	...
	/**
	 * set skip_dfs_cac - Skip DFS_CAC
	 * @priv: Private driver interface data
	 * @set skip_dfs_cac: Ski DFS_CAC
	 * Returns: 0 on success, -1 on failure
	 */
	int (*set_skip_dfs_cac)(void *priv, u8 set_skip_dfs_cac);

	/**
	 * cancel_dfs_cac - Cancel DFS_CAC
	 * @priv: Private driver interface data
	 * Returns: 0 on success, -1 on failure
	 */
	int (*cancel_dfs_cac)(void *priv);
#endif
	...
	/**
	 * set_multi_ap_vlan - set backhaul sta(only) primary vlan
	 * @priv: Private driver interface data
	 * @vlanid: Primary vlan id
	 * @del: 1 for delete primary vlan
	 * Returns: 0 on success, -1 on failure
	 */
	int (*set_multi_ap_vlan)(void *priv, const char *ifname, u16 vlanid, u8 del);
