...
#define DEFAULT_P2P_GO_FREQ_MOVE P2P_GO_FREQ_MOVE_STAY
	...
	/* ecr_rssi- Enhanced Connection Restrict RSSI
	 * This is an optional set of parameters for connecting to an AP.
	 * 0 = do not filter selected AP's RSSI(default)
	 * others = if selected AP's RSSI less then this value,
	 * wpa_supplicant doest NOT connect to this AP.
	 */
	int ecr_rssi;
#endif /* CLS_WIFI_CONFIG  */
};
