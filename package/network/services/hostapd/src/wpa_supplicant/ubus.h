...
#ifdef CLS_WIFI_CONFIG
static inline void wpas_ubus_notify_wpa_state(struct wpa_supplicant *wpa_s, enum wpa_states state)
{
}

static inline void wpas_ubus_notify_wps_state(struct wpa_supplicant *wpa_s, enum wps_event event)
{
}
#endif
