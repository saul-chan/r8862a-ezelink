...
#define AUTH_STATE_INITIAL					0x0
#define AUTH_STATE_RX_CHALLENGE_REQUEST		0x1
#define AUTH_STATE_TX_CHALLENGE_RESPONSE	0x2
#define AUTH_STATE_AUTHORIZED				0X3

struct http_digest_auth_t
{
	int		active; //digest auth
	int		state;	//authentication state
