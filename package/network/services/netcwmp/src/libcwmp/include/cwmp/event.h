...
#define TASK_PERIODIC_INFORM 7

#define EVENT_FILE "/etc/cwmpd/cwmpevent.bin"
...
#define EVENT_REF_UNTIL_DELIVERED	0x40000000
#define EVENT_REF_UNTIL_REBOOTED	0x20000000
