...
#define CWMP_MAX_INDEX_NUM 16
#define CWMP_FULL_PATH 256

#define CWMP_STR_LEN_16 16
#define CWMP_STR_LEN_32 32
#define CWMP_STR_LEN_64 64
#define CWMP_STR_LEN_128 128
#define CWMP_STR_LEN_256 256
#define CWMP_STR_LEN_1025 1025
#define CWMP_IFNAME_LEN 33
...
#define SOAP_ENV_DEFAULT		"SOAP-ENV"	/* for SOAP 1.1 @ https://www.w3.org/TR/2000/NOTE-SOAP-20000508/ */
...
#define STUNUsernameModule                  "STUNUsername"
#define STUNPasswordModule                  "STUNPassword"
#define STUNMaxKeepAlivePeriod              "STUNMaximumKeepAlivePeriod"
#define STUNMinKeepAlivePeriod              "STUNMinimumKeepAlivePeriod"
#define NATDetectedModule                   "NATDetected"
#define AliasBasedAddressing                "AliasBasedAddressing"
#define AliasBasedAddressingValue           "0"
...
#define ROOT_DATA_MODEL_TR098               "InternetGatewayDevice"
#define ROOT_DATA_MODEL_TR181               "Device"


#define DMTR181Param_DeviceRootDMVer        "RootDataModelVersion"
#define DMTR181_ROOTDMVERSION               "2.4"

#define STR_NUM_OF_ENTRIES                  "NumberOfEntries"
#define PATH_DEVICE_WIFI_SSID_NUM           "Device.WiFi.SSIDNumberOfEntries"
#define PATH_DEVICE_WIFI_OBJ_SSID           "Device.WiFi.SSID"
#define PATH_DEVICE_WIFI_OBJ_AP             "Device.WiFi.AccessPoint"
#define TR181_PARAM_NAME_WIFI_RADIO         "Radio"
#define TR181_PARAM_NAME_WIFI_SSID          "SSID"
#define TR181_PARAM_NAME_WIFI_AP            "AccessPoint"

/*UCI netcwmp defination*/
#define UCI_CFG_NETCWMP                     "netcwmp"
#define UCI_SECTION_CWMP                    "cwmp"
#define UCI_SECTION_CWMPD                   "cwmpd"
#define UCI_SECTION_STUN                    "stun"
#define UCI_PARA_ENABLE                     "enable"
#define UCI_PARA_ACS_USERNAME               "acs_username"
#define UCI_PARA_ACS_PASSWORD               "acs_password"
#define UCI_PARA_CPE_USERNAME               "cpe_username"
#define UCI_PARA_CPE_PASSWORD               "cpe_password"
#define UCI_PARA_CPE_PC                     "cpe_pc"
#define UCI_PARA_CPE_VERSION                "cpe_version"
#define UCI_PARA_ACS_URL                    "acs_url"
#define UCI_PARA_PINFORM_ENABLE             "pinform_enable"
#define UCI_PARA_PINFORM_INTERVAL           "pinform_interval"
#define UCI_PARA_SERVER_ADDR                "server_addr"
#define UCI_PARA_SERVER_PORT                "server_port"
#define UCI_PARA_USERNAME                   "username"
#define UCI_PARA_PASSWORD                   "password"
#define UCI_PARA_MAX_KEEPALIVE_PERIOD       "max_keepalive_period"
#define UCI_PARA_MIN_KEEPALIVE_PERIOD       "min_keepalive_period"



/*UCI wireless defination*/
#define UCI_CFG_WIRELESS                    "wireless"
#define UCI_SECTION_RADIO                   "radio"
#define UCI_PARA_CHANNEL                    "channel"
...
/*****************	default values ***************************************/
#define TR181_VALUE_MGNTSRV_PERIOD_INFORM_ENABLE     "1"
#define TR181_VALUE_MGNTSRV_PERIOD_INFORM_INTERVAL   "1800"
#define TR181_VALUE_WIFI_2G_CHANNEL                  "11"
#define TR181_VALUE_WIFI_5G_CHANNEL                  "36"
...
struct stun_conf_st
{
	...
	char *username;
	char *password;
	int min_keepalive_period;
	unsigned int max_keepalive_period;
	int keepalive_retry_count;
};
typedef struct stun_conf_st stun_conf_t;

struct stun_st
{
	stun_conf_t stun_conf;
	int state;
	struct sockaddr_in server_addr;
	int nat_detected;	/* -1: unknown; 0: no NAT; 1: NAT detected */
	int nat_timeout_val;
	struct sockaddr_in nat_mapped_addr;
};
typedef struct stun_st stun_t;
