...
void cwmp_conf_init(cwmp_t * cwmp)
{
    ...
    cwmp->udp_port = cwmp_conf_get_int("cwmpd:udp_port");
    ...
    cwmp->cpe_version = cwmp_conf_pool_get(pool, "cwmp:cpe_version");
    ...
    cwmp->event_filename = EVENT_FILE;
	...
	cwmp->stun.stun_conf.username		=	cwmp_conf_pool_get(pool, "stun:username");
	...
	cwmp->stun.stun_conf.keepalive_retry_count	=	cwmp_conf_get_int("stun:keepalive_retry_count");
