...
CWBool CWAssembleJoinResponse(CWProtocolMessage **messagesPtr,
	...
	mandatoryMsgElemCount = mandatoryMsgElemCount + WTPProtocolManager->radiosInfo.radioCount;
