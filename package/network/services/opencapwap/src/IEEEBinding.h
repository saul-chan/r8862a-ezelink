...
/* ********* DEFINE ********* */
#ifndef __CAPWAP_IEEEBINDING_HEADER__
#define __CAPWAP_IEEEBINDING_HEADER__
...
#define WTP_RADIO_MAX 2
//Max num WTP interface for each radio
#define WTP_MAX_INTERFACES 32
//Max num STA for each interface
#define WTP_MAX_STA 128
...
#define WTP_NAME_WLAN_PREFIX "wlan"
#define WTP_NAME_WLAN_PREFIX_LEN 4
#define WTP_NAME_WLAN_SUFFIX_LEN 4
...
/* ++++++++ Eapol Data ++++++++++ */
#define LEN_EAPOL_HEADER 6
#define LEN_EAPOL_VERSION 1
#define LEN_EAPOL_TYPE 1
#define LEN_EAPOL_LEN 2
#define LEN_EAPOL_FIX_LEN 4 /* version + type + len (1 + 1 + 2)*/
#define LEN_EAPOL_KEY_TYPE 1
#define LEN_KEY_INFO 2
#define LEN_KEY_LEN 2
#define LEN_KEY_REPLAY_COUNTER_LEN 8
#define LEN_KEY_NONCE 32
#define LEN_KEY_IV 16
#define LEN_KEY_RSC 8
#define LEN_KEY_ID 8
#define LEN_KEY_MIC 16
#define LEN_KEY_DATA_LEN 2
#define LEN_EAPOL_KEY_INFO_FIX_LEN 95 /* 2 + 2 + 8 +32 + 16 + 8 + 8 + 16 + 2 */
#define LEN_EAPOL_MAX 512

#define EAPOL_VERSION 2
#define EAPOL_TYPE 3 /* Key */
...
typedef struct WTPSTAInfo {
	...
	struct hostapd_eapol_conn eapol_conn; /* EAPOL client socket to hostapd*/
	CWEapolStateSTA eapol_state;
} WTPSTAInfo;
...
CWBool CWWTPGetWlanInterface(int radioIndex, int wlanIndex);
...
#define WTP_NL80211_CHANNELS_NUM 128
...
int CB_getInterfaceInfo(struct nl_msg *msg, void *arg);
...
int CB_getAuthTypeInterface(struct nl_msg *msg, void *arg);

/* NL80211Driver.c */
CWBool nl80211CmdGetChannelInterface(char * interface, int * channel);
CWBool nl80211CmdGetAuthType(char *interface, int *authtype);
CWBool nl80211CmdGetPhyInfo(int indexPhy, struct WTPSinglePhyInfo * singlePhyInfo);
CWBool nl80211CmdGetInterface(int indexPhy, WTPInterfaceInfo * interfaceInfo);
