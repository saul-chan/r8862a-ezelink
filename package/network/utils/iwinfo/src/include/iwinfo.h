...
#define IWINFO_FREQ_10MHZ           (1 << 0)
#define IWINFO_FREQ_20MHZ           (1 << 1)
#define IWINFO_FREQ_HT40PLUS        (1 << 2)
#define IWINFO_FREQ_HT40MINUS       (1 << 3)
#define IWINFO_FREQ_80MHZ           (1 << 4)
#define IWINFO_FREQ_160MHZ          (1 << 5)
#define IWINFO_FREQ_2160MHZ         (1 << 6)
...
enum iwinfo_htmode {
	...
	IWINFO_HTMODE_HE160,
	IWINFO_HTMODE_NOHT_G,
	IWINFO_HTMODE_NOHT_A,
...
#define IWINFO_HTMODE_NOHT_G     (1 << IWINFO_HTMODE_NOHT_G)
#define IWINFO_HTMODE_NOHT_A     (1 << IWINFO_HTMODE_NOHT_A)
