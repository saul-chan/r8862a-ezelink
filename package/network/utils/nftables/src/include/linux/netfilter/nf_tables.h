 ...
 * @NFT_META_URL: HTTP/HTTPS URL
 * @NFT_META_DNS: DNS over TCP/UDP
 * @NFT_META_CLSMARK: conntrack clsmark
 * @NFT_META_OFLD_QUEUE: offload priority queue
 * @NFT_META_OFLD_PCP: offload 802.1p PCP
 * @NFT_META_OFLD_DSCP: offload IPv4/IPv6 DSCP
 */
enum nft_meta_keys {
	NFT_META_LEN,
	NFT_META_PROTOCOL,
