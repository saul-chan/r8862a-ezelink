...
%token URL			"url"
%token DNS			"dns"
%token CLSMARK			"clsmark"
%token OFLD_QUEUE		"ofld-queue"
%token OFLD_PCP			"ofld-pcp"
%token OFLD_DSCP		"ofld-dscp"
%token QOS_BR_RULE0		"qos-br-rule0"
%token QOS_BR_RULE1		"qos-br-rule1"
%token QOS_BR_RULE2		"qos-br-rule2"
%token QOS_BR_RULE3		"qos-br-rule3"
%token QOS_BR_RULE4		"qos-br-rule4"
%token QOS_BR_RULE5		"qos-br-rule5"
%token QOS_BR_RULE6		"qos-br-rule6"
%token QOS_BR_RULE7		"qos-br-rule7"
...
meta_key_unqualified	:	MARK		{ $$ = NFT_META_MARK; }
			...
			|       URL		{ $$ = NFT_META_URL; }
			|       DNS		{ $$ = NFT_META_DNS; }
			|	CLSMARK		{ $$ = NFT_META_CLSMARK; }
			|       OFLD_QUEUE	{ $$ = NFT_META_OFLD_QUEUE; }
			|       OFLD_PCP	{ $$ = NFT_META_OFLD_PCP; }
			|       OFLD_DSCP	{ $$ = NFT_META_OFLD_DSCP; }
			|       QOS_BR_RULE0	{ $$ = NFT_META_QOS_BR_RULE0; }
			|       QOS_BR_RULE1	{ $$ = NFT_META_QOS_BR_RULE1; }
			|       QOS_BR_RULE2	{ $$ = NFT_META_QOS_BR_RULE2; }
			|       QOS_BR_RULE3	{ $$ = NFT_META_QOS_BR_RULE3; }
			|       QOS_BR_RULE4	{ $$ = NFT_META_QOS_BR_RULE4; }
			|       QOS_BR_RULE5	{ $$ = NFT_META_QOS_BR_RULE5; }
			|       QOS_BR_RULE6	{ $$ = NFT_META_QOS_BR_RULE6; }
			|       QOS_BR_RULE7	{ $$ = NFT_META_QOS_BR_RULE7; }
			;
