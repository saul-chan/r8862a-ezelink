...
const struct meta_template meta_templates[] = {
	...
	[NFT_META_SDIFNAME]	= META_TEMPLATE("sdifname", &ifname_type,
						IFNAMSIZ * BITS_PER_BYTE,
						BYTEORDER_HOST_ENDIAN),
	[NFT_META_URL]		= META_TEMPLATE("url", &string_type,
						32 * BITS_PER_BYTE,
						BYTEORDER_HOST_ENDIAN),
	[NFT_META_DNS]		= META_TEMPLATE("dns", &string_type,
						40 * BITS_PER_BYTE,
						BYTEORDER_HOST_ENDIAN),
	[NFT_META_CLSMARK]	= META_TEMPLATE("clsmark", &mark64_type,
						8 * BITS_PER_BYTE,
						BYTEORDER_HOST_ENDIAN),
	[NFT_META_OFLD_QUEUE]	= META_TEMPLATE("ofld-queue", &integer_type,
						1 * BITS_PER_BYTE,
						BYTEORDER_HOST_ENDIAN),
	[NFT_META_OFLD_PCP]	= META_TEMPLATE("ofld-pcp", &integer_type,
						1 * BITS_PER_BYTE,
						BYTEORDER_HOST_ENDIAN),
	[NFT_META_OFLD_DSCP]	= META_TEMPLATE("ofld-dscp", &integer_type,
						1 * BITS_PER_BYTE,
						BYTEORDER_HOST_ENDIAN),
	[NFT_META_QOS_BR_RULE0]	= META_TEMPLATE("qos-br-rule0", &integer_type,
						1 * BITS_PER_BYTE,
						BYTEORDER_HOST_ENDIAN),
	[NFT_META_QOS_BR_RULE1]	= META_TEMPLATE("qos-br-rule1", &integer_type,
						1 * BITS_PER_BYTE,
						BYTEORDER_HOST_ENDIAN),
	[NFT_META_QOS_BR_RULE2]	= META_TEMPLATE("qos-br-rule2", &integer_type,
						1 * BITS_PER_BYTE,
						BYTEORDER_HOST_ENDIAN),
	[NFT_META_QOS_BR_RULE3]	= META_TEMPLATE("qos-br-rule3", &integer_type,
						1 * BITS_PER_BYTE,
						BYTEORDER_HOST_ENDIAN),
	[NFT_META_QOS_BR_RULE4]	= META_TEMPLATE("qos-br-rule4", &integer_type,
						1 * BITS_PER_BYTE,
						BYTEORDER_HOST_ENDIAN),
	[NFT_META_QOS_BR_RULE5]	= META_TEMPLATE("qos-br-rule5", &integer_type,
						1 * BITS_PER_BYTE,
						BYTEORDER_HOST_ENDIAN),
	[NFT_META_QOS_BR_RULE6]	= META_TEMPLATE("qos-br-rule6", &integer_type,
						1 * BITS_PER_BYTE,
						BYTEORDER_HOST_ENDIAN),
	[NFT_META_QOS_BR_RULE7]	= META_TEMPLATE("qos-br-rule7", &integer_type,
						1 * BITS_PER_BYTE,
						BYTEORDER_HOST_ENDIAN),
