...
return view.extend({
	...
	handleGatherSysinfo: function(ev) {
		var form = E('form', {
			method: 'post',
			action: L.env.cgi_base + '/gathersysinfo',
		...
		ui.changes.displayStatus('notice spinning',
                    E('p', _('Starting gathering sysinfo...')));

		window.setTimeout(function() {
			ui.changes.displayStatus(false);
		}, L.env.apply_display*5000);
	},
	...
	render: function(rpc_replies) {
		...
		s.tab('webgui', _('WebGUI Switching'));
		s.tab('sysinfo', _('Gather Sysinfo'));
		 ...
		 * WebGUI Switching
		 */
		o = s.taboption('webgui', form.ListValue, '_webgui', _('WebGUI Switching'))
		o.uciconfig = 'uhttpd';
		o.ucisection = 'main';
		o.ucioption = 'home';
		 ...
		 * Gather Sysinfo
		 */
		o = s.taboption('sysinfo', form.Button, '_sysinfo', _('Download Sysinfo'), _('Click "Gather Sysinfo" to download a tar archive of the current sysinfo.'));
		o.inputtitle = _('Gather Sysinfo');
		o.inputstyle = 'apply';
		o.onclick = this.handleGatherSysinfo;
