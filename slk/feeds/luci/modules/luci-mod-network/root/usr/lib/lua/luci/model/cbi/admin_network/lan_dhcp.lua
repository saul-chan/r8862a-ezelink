...
local ltime = s:option( Value, "leasetime", translate("Lease time"),
...
dv = s:option(DummyValue, "_separate")
dv.titleref = dsp.build_url("admin", "network", "dhcp")
dv.rawhtml  = true
