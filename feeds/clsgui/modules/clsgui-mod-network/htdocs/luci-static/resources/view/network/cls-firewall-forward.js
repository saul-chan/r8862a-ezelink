...
'require tools.cls-firewall as fwtool';
...
return view.extend({
    ...
    renderForwards: function(data) {
        ...
        o = s.option(widgets.ZoneSelect, 'src', _('Source zone'));
        o.modalonly = true;
        o.rmempty = false;
        o.nocreate = true;
        o.default = 'wan';
        ...
        o = s.option(widgets.ZoneSelect, 'dest', _('Internal zone'));
        o.modalonly = true;
        o.rmempty = true;
        o.nocreate = true;

        o = fwtool.addIPOption(s, 'dest_ip', _('Internal IP address'),
