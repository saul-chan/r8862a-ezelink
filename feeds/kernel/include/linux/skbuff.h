 ...
 * |--BIT31:24--|---BIT23---|--BIT22:16--|----BIT15----|--BIT14:12--|--BIT11:0--|
 * |  node type | vif valid |   vif idx  | node valid  |  radio idx |  node idx |
 */
	__u32			src_port;
	__u32			dest_port;
#define CLS_BMU_FLAG_ETH	BIT(0)
#define CLS_BMU_FLAG_NETWORK	BIT(1)
#define CLS_BMU_FLAG_LEARNING	BIT(2)
#define CLS_BMU_FLAG_NON_TXQ	BIT(3)
#define CLS_BMU_FLAG_HW_ACCEL	BIT(4)
	__u32			bmu_flag;
	unsigned char		*bmu_ethhdr;
	struct {
		u16	valid:1,
			tid:3;
		/* copied from npe_drv dubhe2000_tag.h */
		union {
			u16 raw;
			struct {
