...
static inline bool nft_set_is_cls_set(u8 klen)
{
	return (klen == URL_SIZE || klen == DNS_SIZE);
}
...
void nft_register_cls_match(bool (*fn)(const void *key, const void *pattern, u8 klen));
