...
#define DSA_TAG_PROTO_MOTORCOMM_VALUE    18
#define DSA_TAG_PROTO_MOTORCOMM_VLAN_VALUE    19
...
enum dsa_tag_protocol {
	...
	DSA_TAG_PROTO_MOTORCOMM		= DSA_TAG_PROTO_MOTORCOMM_VALUE,
	DSA_TAG_PROTO_MOTORCOMM_VLAN	= DSA_TAG_PROTO_MOTORCOMM_VLAN_VALUE,
};
