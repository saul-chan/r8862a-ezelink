...
#define RD_WAIT_CTRL_ENABLE	0x4
...
#define SDHCI_MBIU_CTRL_REG	0x10
#define SDHCI_BURST_INCR_EN	BIT(0)
#define SDHCI_BURST_INCR4_EN	BIT(1)
#define SDHCI_BURST_INCR8_EN	BIT(2)
#define SDHCI_BURST_INCR16_EN	BIT(3)
#define SDHCI_BURST_INCR_MASK	0x0F
