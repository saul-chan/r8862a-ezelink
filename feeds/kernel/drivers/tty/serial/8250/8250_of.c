			...
			struct of_serial_info *info)
{
	...
	if (IS_ENABLED(CONFIG_SERIAL_8250_CLS) &&
	    of_device_is_compatible(np, "clourney,ns16550")) {
		port->handle_irq = cls8250_handle_irq;
		port->has_sysrq = IS_ENABLED(CONFIG_SERIAL_8250_CONSOLE);
	}
...
static const struct of_device_id of_platform_serial_table[] = {
	...
	{ .compatible = "clsemi,ns16550-afe", .data = (void *)PORT_CLSEMI, },
	{ /* end of list */ },
};
