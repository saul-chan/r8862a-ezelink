...
static void dw_apb_clockevent_handler(struct clock_event_device *evt)
{
	pr_info("dw_apb_clockevent_handler\n");
}
		       ...
		       void __iomem *base, int irq, unsigned long freq)
{
	...
	dw_ced->ced.event_handler = dw_apb_clockevent_handler;
