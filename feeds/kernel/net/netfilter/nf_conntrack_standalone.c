...
unsigned int nf_conntrack_offload_thresh __read_mostly;
EXPORT_SYMBOL_GPL(nf_conntrack_offload_thresh);
...
static struct ctl_table nf_ct_netfilter_table[] = {
	...
	{
		.procname	= "nf_conntrack_offload_thresh",
		.data		= &nf_conntrack_offload_thresh,
		.maxlen		= sizeof(unsigned int),
		.mode		= 0644,
