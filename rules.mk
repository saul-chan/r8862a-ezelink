...
export PATH_WITHOUT_STAGING_HOST:=$(subst $(space),:,$(filter-out $(STAGING_DIR_HOST)/bin,$(subst :,$(space),$(PATH))))
...
# key for secure upgrade
BUILD_KEY=$(TOPDIR)/keypair/secure-upgrade-keys/cls-key
# key for secure boot
SECURE_BOOT_KEY=$(TOPDIR)/keypair/secure-boot-keys/cls-key
