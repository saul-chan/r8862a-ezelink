...
define Build/U-Boot/Target
 ...
 define Package/u-boot-$(1)
  ...
  ifeq ($(BUILD_TARGET),clsemi)
  define Package/u-boot-$(1)/config
    menu "Configuration"
      depends on PACKAGE_u-boot-$(1)
      config UBOOT_CHECK_FIT_SIGN-$(1)
        bool
        default n
        prompt "u-boot check signature of the fit image"
    endmenu
  endef
  endif
endef
